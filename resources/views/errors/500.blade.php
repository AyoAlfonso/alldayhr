...
<body style=" background: url('https://www.nannyfix.com/img/noise.gif');">
...
<div class="container">
    <div class="error-wrapper">
        <img src="https://42f2671d685f51e10fc6-b9fcecea3e50b3b59bdc28dead054ebc.ssl.cf5.rackcdn.com/illustrations/server_down_s4lk.svg" style="height:200px;"/>
        <h3 class="title">500</h3>
        <p class="info">Internal Server Error.</p>
        <a href="{{ url('/') }}">
