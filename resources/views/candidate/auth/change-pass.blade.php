...
@section('contents')
        ...
        <div class="col-md-4 wrap-contact100">
                    ...
                    <form class="form-gray-fields" action="{{ URL::to('/candidate/recover-password').'/'.$token }}" method="POST">
                        @if ($errors->any())
                            <div class="col-md-12">
                                <div class="col-md-12">
                        ...
                        <div class="col-md-12">
                            <div class="form-group"   style="color: rgba(46, 56, 77, 0.5)">
                                ...
                                <input type="text" class="form-control auth-input-field" name="password" id="candidatePassword" placeholder="****" required="true">
                            </div>
                        </div>
            ...
            <div class="col-md-12 text-center" style="margin-top: 2%;margin-bottom: 15%;">
                <div class="gray-info">
                 <span class="mouse-point" style="width: 50%;"> <a 
                    ...
                    style="color: #fff;"> Remember your password ? Log In </a></span>
                    </div>
                </div>
            </div>
        </div>
