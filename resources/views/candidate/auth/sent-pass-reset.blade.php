    ...
    <div class="" style="">
        ...
        <div class="col-md-4"></div>
            ...
            <div class="col-md-4 wrap-contact200 wc-verification-card">
                ...
                @if($invalid == 0)
                    <span class="col-sm-12 text-center click-instruction" style="font-weight: bold;font-size: 24px;line-height: 26px;">
                     You're almost ready
                    </span>
                ...
                <div class="col-md-12 text-center">
                 <div class="gray-info">
                   <span class="mouse-point" style="width: 50%;"> <a
                     href="{{ route('candidate.resend-recover-pass').'?ref='.$email.'&resend='.'1'}}"
                     style="color: rgba(255, 255, 255, 0.5);"> 
                    Didn’t get the reset password link? Resend it.
                </a></span>
                 </div>
               </div>
            </div>
