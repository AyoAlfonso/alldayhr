        ...
        <div class="col-md-4"></div>
            ...
            <div class="row">
                <div class="col-md-12 text-center">
                 <div class="gray-info">
                   <span class="mouse-point" style="width: 50%;"> <a href="{{ route('candidate.resend-verify-acc').'?ref='.$email.'&resend='.$resendtoken}}" style="color: rgba(255, 255, 255, 0.5);"> 
                    Didn’t get the link? Resend it.
                </a></span>
                 </div>
               </div>
            </div>
